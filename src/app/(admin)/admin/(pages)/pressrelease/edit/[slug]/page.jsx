...
export default function EditPressRelease() {
    ...
    const fetchData = async () => {
      try {
        ...
        setFormData({
          ...
          status: pressData.status || "draft",
        });
        
        setExistingImage(pressData.featured_image || null);
        setCurrentStatus(pressData.status || "draft");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Only allow status change if user is admin (you can add role check here)
  ...
  const getStatusColor = (status) => {
    const colors = {
      ...
      syndicated: "bg-purple-100 text-purple-800"
    };
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex justify-between items-center mb-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={`px-2 py-1 rounded-full text-xs font-semibold ${getStatusColor(formData.status)}`}>
          ...
          <div className="border-t border-gray-200 pt-5 mt-5">
            ...
            <div className="bg-gray-50 rounded-md p-3 space-y-2">
              ...
              <p className="text-xs text-gray-500">
                Note: Credits will be deducted when status changes to "Approved"
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 flex justify-end gap-3">
            <button
              type="button"
              onClick={() => router.push("/admin/pressrelease")}
