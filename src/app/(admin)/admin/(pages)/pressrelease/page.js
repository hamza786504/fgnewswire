...
export default function PressRelease() {
  ...
  return (
    <>
      {/* Main content */}
      <main className="flex-1 rounded-bl-4xl overflow-y-scoll bg-[#ebecf0] h-full p-4 md:pb-6 md:px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
            <h1 className="text-2xl font-bold text-gray-800 mb-4 md:mb-0">Manage Your Press Releases</h1>
          </div>
